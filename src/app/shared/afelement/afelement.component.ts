  ...
  ngAfterViewInit() {
    ...
    for(var i=0; i<= this.tagNumberlength; i++)
      ...
      if(this.item.images![i].type == "video")
      {
        ...
        marker.insertAdjacentHTML('beforeEnd', 
        entities+'<a-entity template="src: #plane" data-thumb="#img123" class="clickable" gesture-handler="minScale: 0.25; maxScale: 10" rotation="-90, 0, 0" geometry="primitive: plane; height: '+height+'; width: '+width+'" material="shader: flat; src: #img'+indexPath+'"></a-entity>');
